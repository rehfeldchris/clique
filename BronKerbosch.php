...
function bronKerbosch($potentialClique, $candidateVerts, $alreadyFoundVerts, $adjacencyList) {
    if (!$candidateVerts && !$alreadyFoundVerts) {
        //found maximal clique
        $GLOBALS['cliques'][] = $potentialClique;
        print_r($potentialClique);
        return;
    }
...
function bronKerboschWithPivoting($potentialClique, $candidateVerts, $alreadyFoundVerts, $adjacencyList, $pivotChoosingFunction) {
    ...
    foreach (array_diff_key($candidateVerts, $pivotNeighborVerts) as $candidateVert) {
        ...
        bronKerboschWithPivoting($potentialClique, $newCandidates, $newAlreadyFoundVerts, $adjacencyList, $pivotChoosingFunction);
...
function bronKerboschWithVertexOrdering($potentialClique, $candidateVerts, $alreadyFoundVerts, $adjacencyList, $pivotChoosingFunction) {
    echo "sort start\n";
    ...
    echo "sort end";
    return bronKerboschWithPivoting($potentialClique, $candidateVerts, $alreadyFoundVerts, $adjacencyList, $pivotChoosingFunction);
}